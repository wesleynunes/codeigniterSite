...
class Upload extends CI_Controller
{
    ...
    function index(){        
        $this->template->load('template_painel', 'oficina/upload/upload_form', array('error' => ' ' ));
    }  
    ...
    function do_upload()
	{
		...
		*/
		...
		if ( ! $this->upload->do_upload())
		{
			...
			$this->template->load('template_painel','oficina/upload/upload_form', $error);
		}
		else
		{
			...
			$this->template->load('template_painel','oficina/upload/upload_success', $data);
		}
	}
