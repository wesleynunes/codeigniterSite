...
<body class="bg-gradient-primary">
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    ...
                    <?php echo form_open('/autenticacao/verificar_login'); ?>  <!-- encaminha para verificar senha e usuario -->    

                  <form class="user">
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" id="usuario"  name="usuario" aria-describedby="emailHelp" placeholder="Entre com seu usuario">
                    </div>
                    <div class="form-group">
  ...
  <script src="<?php echo base_url(); ?>assets/painel/vendor/jquery-easing/jquery.easing.min.js"></script>

  <!-- Custom scripts for all pages-->
  <script src="<?php echo base_url(); ?>assets/painel/js/sb-admin-2.min.js"></script> 
