...
<body>
	...
	<div class="panel panel-primary">
		...
		<div class="panel-body">
			<?php echo form_open_multipart('oficina/upload_registrado/upload', array('role'=>'form'));
			if(isset($message)): 
		...
		<?php foreach($uploaded_images as $images):?>
			<div class="col-md-6">
				<div class="well">
					<img src="<?php echo base_url()."./assets/uploads/oficina/upload_reg/".$images->file_dir;?>" alt="" class="img-thumbnail" width="100%" height="auto"/>
